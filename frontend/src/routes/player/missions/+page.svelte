<script>
  ...
  // to avoid O(N*M) rendering bottleneck caused by evaluating .some() on each iteration.
  // Using Svelte's reactive declaration ($:) ensures it updates when playerMissions changes.
