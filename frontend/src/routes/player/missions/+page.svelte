<script>
  ...
  // ⚡ Optimization: Pre-compute completed missions as a Set to avoid O(N^2) rendering bottlenecks
  // in Svelte {#each} blocks by transforming O(N) array search inside a loop to O(1) Set lookup.
